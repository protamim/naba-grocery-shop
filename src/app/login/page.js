...
const LoginPage = () => {
  return (
    <>
      <section className="bg-slate-200 min-h-[80vh] flex flex-col justify-center items-center">
        <div className="bg-white rounded-md basis-full mx-4 lg:w-[calc(100%/2)]">
          {/* Login Header */}
          ...
          <div className="bg-slate-100 rounded-b-md rounded-t-2xl pt-5 pb-3">
            ...
            <div className="flex justify-center items-center gap-x-2">
              ...
              <Link href="#" className="text-orange-600 font-semibold transition-all duration-300 ease-in-out hover:opacity-70 hover:underline">Sign Up</Link>
            </div>
